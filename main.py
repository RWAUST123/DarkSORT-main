...
def get_main_args():
    ...
    elif args.dataset == "mine-mot":
        args.result_folder = os.path.join(args.result_folder, "MINE-MOT-val")
...
def main():
    ...
    if args.dataset == "mot17":
        if args.test_dataset:
            ...
            detector_path = "external/weights/mine-mot.pth.tar"
        size = (800, 1440)
    elif args.dataset == "mine-mot":
        if args.test_dataset:
            detector_path = "external/weights/mine-mot.tar"
            size = (896, 1600)
        else:
    ...
    det = detector.Detector("yolov7", detector_path, args.dataset)
